...
def debug_charge_setpoint(soc, soc_target, afternoon_window_h, capacity_wh=5000, max_power_w=2200):
    print(f"Input: soc={soc}, soc_target={soc_target}, afternoon_window_h={afternoon_window_h}")
    ...
    print(f"spread_w = {gap_wh} / {afternoon_window_h} = {spread_w} W")
